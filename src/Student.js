        ...
        <div className="student">
            <div className="student__text-wrapper">
                ...
                <div className="student-description">
                    <div
                        className="student-name">{student.firstName.toUpperCase() + " " + student.lastName.toUpperCase()}</div>
                    ...
                    <button className="button-tag" onClick={() => {
                        addTag(tagInput, student.id);
                        setTagInput('')
                    }}>new tag
                    </button>
                    <div className="input-field col s6">
                        <input id="Tag" type="text" className="validate" value={tagInput}
